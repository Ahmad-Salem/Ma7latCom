...
public class Product_Rest_Images_Adapter_own extends PagerAdapter {
    ...
    //default constractor
    public Product_Rest_Images_Adapter_own() {
    }

    //customized constractor

    public Product_Rest_Images_Adapter_own(Context mContext, String list_Produst_Details) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = layoutInflater_product_details.inflate(R.layout.product_details_slider_own, container, false);



        ImageView SildeImageView=(ImageView) view.findViewById(R.id.product_details_silder_id22);
