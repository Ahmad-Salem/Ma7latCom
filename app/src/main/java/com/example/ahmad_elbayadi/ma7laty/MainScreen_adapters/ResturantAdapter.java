...
public class ResturantAdapter extends RecyclerView.Adapter<ResturantAdapter.MyViewHolder_res> {
    private Context context;
    private List<resturant_model> offers_data;
    RequestOptions option;


    public ResturantAdapter(Context context, List<resturant_model> offers_data) {
    ...
    @NonNull
    @Override
    public ResturantAdapter.MyViewHolder_res onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_resturant,parent,false);
        return new ResturantAdapter.MyViewHolder_res(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ResturantAdapter.MyViewHolder_res holder,  int position) {
        try{
            ...
            Log.i("ResAdapter","empty"+offers_data.get(position).getOffer_name());
            //on click listener
    ...
    public class MyViewHolder_res extends RecyclerView.ViewHolder
    {
        RelativeLayout leftSide;
        ImageView SildeImageView;
        TextView title1;
        TextView des1;
        public MyViewHolder_res(@NonNull View itemView) {
            super(itemView);
            ...
            leftSide=(RelativeLayout) itemView.findViewById(R.id.leftSide2);
//        RelativeLayout rightSide=(RelativeLayout) view.findViewById(R.id.rightSide);
            SildeImageView=(ImageView) itemView.findViewById(R.id.offers_silder_id22);
//            ImageView SildeImageView2=(ImageView) itemView.findViewById(R.id.offers_silder_id2);
            title1=(TextView)itemView.findViewById(R.id.offername12);
//        TextView title2=(TextView)view.findViewById(R.id.offername2);
            des1=(TextView)itemView.findViewById(R.id.description12);
