...
public class Edit_product_photo extends AppCompatActivity {

    private TextView toolbar,product_title;
    private Button select_product_photo,edit_product;
    private ImageView product_photo_preview;
    private Typeface tf;
    private RequestOptions option;
    private String intent_shop_id,intent_product_id,intent_product_photo;
    private final String JSON_URL="http://www.ma7latcom.com/59a1cac00edcbfa80c57957dc1e9018a/API/shop_owner_credential/shop_setting/edit_product_main_photo.php";
    private RequestQueue requestQueue_edit_product_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar_actual = (Toolbar)findViewById(R.id.newuser_activity_toolbar_add_shop_2299ofpro);
        ...
        toolbar=(TextView)findViewById(R.id.toolbar_title_reg_add_shop_2299ofpro);
        product_title=(TextView)findViewById(R.id.shop_title99ofpro);
        select_product_photo=(Button)findViewById(R.id.photo_shop99ofpro);
        edit_product=(Button)findViewById(R.id.add_new_shop99ofpro);
        product_photo_preview=(ImageView)findViewById(R.id.shop_photo_reg99ofpro);
        ...
        select_product_photo.setTypeface(tf);
        ...
        intent_product_photo=getIntent().getExtras().getString("product_photo");
        ...
        Glide.with(this).load(intent_product_photo).apply(option).into(product_photo_preview);

        select_product_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectImagev2();
            }
    ...
    private void selectImage() {
        product_photo_preview.setImageResource(0);
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};

        AlertDialog.Builder builder = new AlertDialog.Builder(Edit_product_photo.this);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                try {
                    ...
                    bitmap = MediaStore.Images.Media.getBitmap(Edit_product_photo.this.getContentResolver(), data.getData());
                    setToImageView(getResizedBitmap(bitmap, max_resolution_image));
                } catch (IOException e) {
                    e.printStackTrace();
                }
...
//                    Toast.makeText(getApplicationContext(),""+jsonObject.getString("product_edit_flage"),Toast.LENGTH_LONG).show();
                    if(response!=null)
                    {
//                        Toast.makeText(getApplicationContext(),"response is not null",Toast.LENGTH_LONG).show();
                        Log.i("jsonopopop",jsonObject+"");
                    }
                    if(jsonObject.getString("product_edit_flage").equals("1"))
                    {
//                        intent to activation code activity
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("do_action", "edit_main_product_photo");
                params.put("id", ID);
        ...
        requestQueue_edit_product_photo= Volley.newRequestQueue(this);
        requestQueue_edit_product_photo.add(request_reg);
    }
