...
public class CarpetsAdapter extends RecyclerView.Adapter<CarpetsAdapter.MyViewHolder> {
    private Context context;
    private LayoutInflater layoutInflater_offers;
    private List<carpet_model> offers_data;
    RequestOptions option;


    public CarpetsAdapter(Context context, List<carpet_model> offers_data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_carpets,parent,false);
        return new CarpetsAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CarpetsAdapter.MyViewHolder holder, int position) {
        try{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            leftSide=(RelativeLayout) itemView.findViewById(R.id.leftSide_car);
//        RelativeLayout rightSide=(RelativeLayout) view.findViewById(R.id.rightSide);
            SildeImageView=(ImageView) itemView.findViewById(R.id.offers_silder_id_car);
//            ImageView SildeImageView2=(ImageView) itemView.findViewById(R.id.offers_silder_id2);
            title1=(TextView)itemView.findViewById(R.id.offername1_car);
//        TextView title2=(TextView)view.findViewById(R.id.offername2);
            des1=(TextView)itemView.findViewById(R.id.description1_car);
