...
public class Product_with_photo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.product_with_photo,container,false);


        recyclerView_list_of_products=view.findViewById(R.id.recycle_products);
        product_list=new ArrayList<>();

        data_text=(TextView)view.findViewById(R.id.data_text_list_of_shop_pro12);

        internet_connection_text=(TextView)view.findViewById(R.id.connection_text_list_of_shop_pro12);
        retry_btn=(Button)view.findViewById(R.id.retry_list_of_shop_pro12);
        internet_layout=(RelativeLayout) view.findViewById(R.id.list_of_shop_internet_connection_layout_pro12);
        data_layout=(RelativeLayout)view.findViewById(R.id.list_of_product_data_null);
    ...
    private void SettingUpRecycleView(List<List_Of_Product_property> product_list) {
        List_Of_Product_Adapter mRecycleViewAdapter=new List_Of_Product_Adapter(getContext(),product_list);
