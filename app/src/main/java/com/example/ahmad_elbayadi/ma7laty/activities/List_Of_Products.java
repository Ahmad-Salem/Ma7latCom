...
import com.example.ahmad_elbayadi.ma7laty.List_Of_Shop_adapters.List_Of_Product_Adapter;
...
public class List_Of_Products extends AppCompatActivity {
    ...
    private final String JSON_URL="http://www.ma7latcom.com/59a1cac00edcbfa80c57957dc1e9018a/API/listOfShops/products_list.php";
    private RequestQueue requestQueue_products;
    private RecyclerView recyclerView_list_of_products;
    private List<List_Of_Product_property> product_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list__of__products);
        ...
        recyclerView_list_of_products=findViewById(R.id.recycle_products);
        product_list=new ArrayList<>();

        data_text=(TextView)findViewById(R.id.data_text_list_of_shop_pro12);

        internet_connection_text=(TextView)findViewById(R.id.connection_text_list_of_shop_pro12);
        retry_btn=(Button)findViewById(R.id.retry_list_of_shop_pro12);
        internet_layout=(RelativeLayout) findViewById(R.id.list_of_shop_internet_connection_layout_pro12);
        data_layout=(RelativeLayout)findViewById(R.id.list_of_product_data_null);


        //casting android screen component
        toolbartitle=(TextView)findViewById(R.id.toolbar_title_product_list);
    ...
    private void jsonRequest_produsts_list() {
        //receive data
        final String Shop_id=getIntent().getExtras().getString("Shop_id_products");
            ...
            public void onResponse(String response) {
                ...
                for (int i = 0; i < jsonObject.length(); i++)
                {
                    try{
                        ...
                        List_Of_Product_property product_model=new List_Of_Product_property();
                        ...
                        product_model.setUser_name(jsonObject2.getString("user_name"));
                        product_model.setEmail(jsonObject2.getString("email"));
                        product_model.setPhoto(jsonObject2.getString("photo"));
                        product_model.setAddress(jsonObject2.getString("address"));
                        product_model.setTelephone1(jsonObject2.getString("telephone1"));
                        product_model.setTelephone2(jsonObject2.getString("telephone2"));
    ...
    private void SettingUpRecycleView(List<List_Of_Product_property> product_list) {
        List_Of_Product_Adapter mRecycleViewAdapter=new List_Of_Product_Adapter(this,product_list);
