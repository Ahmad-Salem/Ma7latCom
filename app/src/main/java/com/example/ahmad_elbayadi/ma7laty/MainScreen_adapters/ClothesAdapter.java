...
public class ClothesAdapter extends RecyclerView.Adapter<ClothesAdapter.MyViewHolder> {
    ...
    private List<clothes_model> offers_data;
    RequestOptions option;


    public ClothesAdapter(Context context, List<clothes_model> offers_data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_clothes,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            leftSide=(RelativeLayout) itemView.findViewById(R.id.leftSide_clothes);
//        RelativeLayout rightSide=(RelativeLayout) view.findViewById(R.id.rightSide);
            SildeImageView=(ImageView) itemView.findViewById(R.id.offers_silder_id_clothes);
//            ImageView SildeImageView2=(ImageView) itemView.findViewById(R.id.offers_silder_id2);
            title1=(TextView)itemView.findViewById(R.id.offername1_clothes);
//        TextView title2=(TextView)view.findViewById(R.id.offername2);
            des1=(TextView)itemView.findViewById(R.id.description1_clothes);
